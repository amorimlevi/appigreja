...
const Login = ({ onLogin }) => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 px-4">
            <div className="max-w-md w-full space-y-8">
                <div className="text-center">
                    <img 
                        src="https://res.cloudinary.com/dxchbdcai/image/upload/v1759588261/Captura_de_Tela_2025-10-04_%C3%A0s_11.30.40_ydns5v.png" 
                        alt="Logo da Igreja" 
                        className="w-20 h-20 mx-auto mb-4 object-contain"
                    />
                    <h2 className="text-3xl font-bold text-white mb-2">Igreja Zoe</h2>
                    <p className="text-gray-400">"E perseveravam na doutrina dos apóstolos, e na comunhão, e no partir do pão, e nas orações."</p>
                </div>
                ...
                <div className="text-center text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <p className="font-mono bg-gray-800 dark:bg-gray-700 text-gray-200 px-3 py-2 rounded mt-2">
                        Usuário: <span className="text-white font-semibold">pastor</span> | Senha: <span className="text-white font-semibold">zoe2025</span>
                    </p>
                </div>
            </div>
        </div>
